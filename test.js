...
var promises = [];
promises.push(Connection.execute('DROP TABLE IF EXISTS test1;').then(() => {
    promises.push(Connection.execute('CREATE TABLE test1 (fl_name varchar(32), fl_value varchar(32));').then(() => {
